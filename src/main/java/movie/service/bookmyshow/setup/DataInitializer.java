...
import movie.service.bookmyshow.models.SeatType;
...
import movie.service.bookmyshow.models.User;
import movie.service.bookmyshow.models.Features;
...
import movie.service.bookmyshow.repositories.SeatsRepository;
import movie.service.bookmyshow.repositories.MovieRepository;
import movie.service.bookmyshow.repositories.ShowRepository;
import movie.service.bookmyshow.repositories.ShowSeatRepository;
import movie.service.bookmyshow.repositories.SeatTypeShowRepository;
...
public class DataInitializer implements CommandLineRunner {
  ...
  @Autowired private SeatsRepository seatsRepository;
  @Autowired private MovieRepository movieRepository;
  @Autowired private ShowRepository showRepository;
  @Autowired private ShowSeatRepository showSeatRepository;
  @Autowired private SeatTypeShowRepository seatTypeShowRepository;
  ...
  private List<Seat> seedSeats(Screen screen) {
    ...
    s1.setTopLeftX(0); s1.setTopLeftY(0);
    s1.setBottomRightX(100); s1.setBottomRightY(90);

    Seat s2 = new Seat();
    s2.setName("A2");
    s2.setSeatType(SeatType.PLATINUM);
    s2.setTopLeftX(10); s2.setTopLeftY(0);
    s2.setBottomRightX(110); s2.setBottomRightY(90);

    Seat s3 = new Seat();
    s3.setName("A3");
    s3.setSeatType(SeatType.SILVER);
    s3.setTopLeftX(20); s3.setTopLeftY(0);
    s3.setBottomRightX(120); s3.setBottomRightY(90);

    Seat s4 = new Seat();
    s4.setName("A4");
    s4.setSeatType(SeatType.SILVER);
    s4.setTopLeftX(20); s4.setTopLeftY(0);
    s4.setBottomRightX(120); s4.setBottomRightY(90);

    Seat s5 = new Seat();
    s5.setName("A5");
    s5.setSeatType(SeatType.PLATINUM);
    s5.setTopLeftX(20); s5.setTopLeftY(0);
    s5.setBottomRightX(120); s5.setBottomRightY(90);

    Seat s6 = new Seat();
    s6.setName("A6");
    s6.setSeatType(SeatType.GOLD);
    s6.setTopLeftX(20); s6.setTopLeftY(0);
    s6.setBottomRightX(120); s6.setBottomRightY(90);

    Seat s7 = new Seat();
    s7.setName("A7");
    s7.setSeatType(SeatType.PLATINUM);
    s7.setTopLeftX(20); s7.setTopLeftY(0);
    s7.setBottomRightX(120); s7.setBottomRightY(90);

    Seat s8 = new Seat();
    s8.setName("A8");
    s8.setSeatType(SeatType.SILVER);
    s8.setTopLeftX(20); s8.setTopLeftY(0);
    s8.setBottomRightX(120); s8.setBottomRightY(90);
